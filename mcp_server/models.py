...
class GoogleCloudMlV1AutomatedStoppingConfigDecayCurveAutomatedStoppingConfig(
    ...
    useElapsedTime: Optional[bool] = Field(
        None,
...
class GoogleCloudMlV1AutomatedStoppingConfigMedianAutomatedStoppingConfig(BaseModel):
    useElapsedTime: Optional[bool] = Field(
        None,
...
class GoogleCloudMlV1HyperparameterOutputHyperparameterMetric(BaseModel):
    objectiveValue: Optional[float] = Field(
        None, description='The objective value at this training step.'
    )
    trainingStep: Optional[str] = Field(
        None, description='The global training step for this metric.'
    )


class GoogleCloudMlV1MeasurementMetric(BaseModel):
    metric: Optional[str] = Field(None, description='Required. Metric name.')
    value: Optional[float] = Field(
        None, description='Required. The value for this metric.'
    )
...
class GoogleCloudMlV1StudyConfigParameterSpecDiscreteValueSpec(BaseModel):
...
class GoogleCloudMlV1StudyConfigMetricSpec(BaseModel):
    goal: Optional[Goal] = Field(
        None, description='Required. The optimization goal of the metric.'
    )
    metric: Optional[str] = Field(None, description='Required. The name of the metric.')
...
class GoogleCloudMlV1StudyConfigParameterSpec(BaseModel):
    categoricalValueSpec: Optional[
        GoogleCloudMlV1StudyConfigParameterSpecCategoricalValueSpec
    ] = Field(None, description="The value spec for a 'CATEGORICAL' parameter.")
    childParameterSpecs: Optional[List[GoogleCloudMlV1StudyConfigParameterSpec]] = (
        Field(
            None,
    ...
    discreteValueSpec: Optional[
        GoogleCloudMlV1StudyConfigParameterSpecDiscreteValueSpec
    ] = Field(None, description="The value spec for a 'DISCRETE' parameter.")
    doubleValueSpec: Optional[
        GoogleCloudMlV1StudyConfigParameterSpecDoubleValueSpec
    ] = Field(None, description="The value spec for a 'DOUBLE' parameter.")
    integerValueSpec: Optional[
        GoogleCloudMlV1StudyConfigParameterSpecIntegerValueSpec
    ] = Field(None, description="The value spec for an 'INTEGER' parameter.")
    ...
    scaleType: Optional[ScaleType] = Field(
        None,
        description='How the parameter should be scaled. Leave unset for categorical parameters.',
    )
    type: Optional[Type] = Field(
        None, description='Required. The type of the parameter.'
    )


class GoogleCloudMlV1TrialParameter(BaseModel):
    floatValue: Optional[float] = Field(
        None, description='Must be set if ParameterType is DOUBLE or DISCRETE.'
    )
    intValue: Optional[str] = Field(
        None, description='Must be set if ParameterType is INTEGER'
    )
    parameter: Optional[str] = Field(None, description='The name of the parameter.')
    stringValue: Optional[str] = Field(
        None, description='Must be set if ParameterTypeis CATEGORICAL'
    )
...
class GoogleCloudMlV1AcceleratorConfig(BaseModel):
    ...
    type: Optional[Type1] = Field(None, description='The type of accelerator to use.')
...
class GoogleCloudMlV1BuiltInAlgorithmOutput(BaseModel):
    framework: Optional[str] = Field(
        None, description='Framework on which the built-in algorithm was trained.'
    )
    ...
    pythonVersion: Optional[str] = Field(
        None, description='Python version on which the built-in algorithm was trained.'
    )
...
class GoogleCloudMlV1CancelJobRequest(BaseModel):
    pass


class AvailableAccelerator(Enum):
    ACCELERATOR_TYPE_UNSPECIFIED = 'ACCELERATOR_TYPE_UNSPECIFIED'
    NVIDIA_TESLA_K80 = 'NVIDIA_TESLA_K80'
    NVIDIA_TESLA_P100 = 'NVIDIA_TESLA_P100'
    NVIDIA_TESLA_V100 = 'NVIDIA_TESLA_V100'
...
class GoogleCloudMlV1Capability(BaseModel):
    availableAccelerators: Optional[List[AvailableAccelerator]] = Field(
        None, description='Available accelerators for the capability.'
    )
...
class GoogleCloudMlV1CheckTrialEarlyStoppingStateMetatdata(BaseModel):
    createTime: Optional[str] = Field(
        None, description='The time at which the operation was submitted.'
    )
    study: Optional[str] = Field(
        None, description='The name of the study that the trial belongs to.'
    )
    trial: Optional[str] = Field(None, description='The trial name.')


class GoogleCloudMlV1CheckTrialEarlyStoppingStateRequest(BaseModel):
    pass


class GoogleCloudMlV1CheckTrialEarlyStoppingStateResponse(BaseModel):
    endTime: Optional[str] = Field(
        None, description='The time at which operation processing completed.'
    )
    shouldStop: Optional[bool] = Field(
        None, description='True if the Trial should stop.'
    )
    startTime: Optional[str] = Field(
        None, description='The time at which the operation was started.'
    )


class GoogleCloudMlV1Config(BaseModel):
    tpuServiceAccount: Optional[str] = Field(
        None, description='The service account Cloud ML uses to run on TPU node.'
    )
...
class GoogleCloudMlV1DiskConfig(BaseModel):
    bootDiskSizeGb: Optional[int] = Field(
        None, description='Size in GB of the boot disk (default is 100GB).'
    )
...
class GoogleCloudMlV1ExplainRequest(BaseModel):
    httpBody: Optional[GoogleApiHttpBody] = Field(
        None, description='Required. The explanation request body.'
    )
...
class GoogleCloudMlV1GetConfigResponse(BaseModel):
    ...
    serviceAccountProject: Optional[str] = Field(
        None, description='The project number for `service_account`.'
    )
...
class GoogleCloudMlV1HyperparameterOutput(BaseModel):
    ...
    builtInAlgorithmOutput: Optional[GoogleCloudMlV1BuiltInAlgorithmOutput] = Field(
        None,
    ...
    endTime: Optional[str] = Field(
        None, description='Output only. End time for the trial.'
    )
    finalMetric: Optional[GoogleCloudMlV1HyperparameterOutputHyperparameterMetric] = (
        Field(None, description='The final objective metric seen for this trial.')
    )
    hyperparameters: Optional[Dict[str, str]] = Field(
        None, description='The hyperparameters given to this trial.'
    )
    isTrialStoppedEarly: Optional[bool] = Field(
        None, description='True if the trial is stopped early.'
    )
    startTime: Optional[str] = Field(
        None, description='Output only. Start time for the trial.'
    )
    state: Optional[State] = Field(
        None, description='Output only. The detailed state of the trial.'
    )
    trialId: Optional[str] = Field(None, description='The trial id for these results.')
    webAccessUris: Optional[Dict[str, str]] = Field(
        None,
...
class GoogleCloudMlV1IntegratedGradientsAttribution(BaseModel):
    numIntegralSteps: Optional[int] = Field(
        None,
...
class GoogleCloudMlV1ListOptimalTrialsRequest(BaseModel):
    pass


class GoogleCloudMlV1Location(BaseModel):
    capabilities: Optional[List[GoogleCloudMlV1Capability]] = Field(
        None, description='Capabilities available in the location.'
    )
...
class GoogleCloudMlV1MetricSpec(BaseModel):
    name: Optional[Name] = Field(None, description='metric name.')
...
class GoogleCloudMlV1ParameterSpec(BaseModel):
    ...
    discreteValues: Optional[List[float]] = Field(
        None,
    ...
    scaleType: Optional[ScaleType1] = Field(
        None,
...
class GoogleCloudMlV1PredictionInput(BaseModel):
    ...
    dataFormat: Optional[DataFormat] = Field(
        None, description='Required. The format of the input data files.'
    )
    inputPaths: Optional[List[str]] = Field(
        None,
        description='Required. The Cloud Storage location of the input data files. May contain wildcards.',
    )
    maxWorkerCount: Optional[str] = Field(
        None,
    ...
    outputDataFormat: Optional[OutputDataFormat] = Field(
        None, description='Optional. Format of the output data files, defaults to JSON.'
    )
    outputPath: Optional[str] = Field(
        None, description='Required. The output Google Cloud Storage location.'
    )
...
class GoogleCloudMlV1PredictionOutput(BaseModel):
    errorCount: Optional[str] = Field(
        None, description='The number of data instances which resulted in errors.'
    )
    nodeHours: Optional[float] = Field(
        None, description='Node hours used by the batch prediction job.'
    )
    outputPath: Optional[str] = Field(
        None,
        description='The output Google Cloud Storage location provided at the job creation time.',
    )
    predictionCount: Optional[str] = Field(
        None, description='The number of generated predictions.'
    )


class GoogleCloudMlV1ReplicaConfig(BaseModel):
    acceleratorConfig: Optional[GoogleCloudMlV1AcceleratorConfig] = Field(
        None,
    ...
    containerArgs: Optional[List[str]] = Field(
        None,
    ...
    containerCommand: Optional[List[str]] = Field(
        None,
    ...
    diskConfig: Optional[GoogleCloudMlV1DiskConfig] = Field(
        None, description='Represents the configuration of disk options.'
    )
    ...
    tpuTfVersion: Optional[str] = Field(
        None,
...
class GoogleCloudMlV1Scheduling(BaseModel):
    maxRunningTime: Optional[str] = Field(
        None,
    ...
    maxWaitTime: Optional[str] = Field(
        None,
...
class GoogleCloudMlV1SetDefaultVersionRequest(BaseModel):
    pass


class GoogleCloudMlV1StopTrialRequest(BaseModel):
    pass
...
class GoogleCloudMlV1StudyConfig(BaseModel):
    algorithm: Optional[Algorithm1] = Field(
        None, description='The search algorithm specified for the study.'
    )
    automatedStoppingConfig: Optional[GoogleCloudMlV1AutomatedStoppingConfig] = Field(
        None, description='Configuration for automated stopping of unpromising Trials.'
    )
    metrics: Optional[List[GoogleCloudMlV1StudyConfigMetricSpec]] = Field(
        None, description='Metric specs for the study.'
    )
    parameters: Optional[List[GoogleCloudMlV1StudyConfigParameterSpec]] = Field(
        None, description='Required. The set of parameters to tune.'
    )
...
class GoogleCloudMlV1SuggestTrialsMetadata(BaseModel):
    ...
    createTime: Optional[str] = Field(
        None, description='The time operation was submitted.'
    )
    study: Optional[str] = Field(
        None, description='The name of the study that the trial belongs to.'
    )
    suggestionCount: Optional[int] = Field(
        None, description='The number of suggestions requested.'
    )
...
class GoogleCloudMlV1SuggestTrialsRequest(BaseModel):
    ...
    suggestionCount: Optional[int] = Field(
        None, description='Required. The number of suggestions requested.'
    )
...
class GoogleCloudMlV1TrainingOutput(BaseModel):
    ...
    completedTrialCount: Optional[str] = Field(
        None,
    ...
    consumedMLUnits: Optional[float] = Field(
        None, description='The amount of ML units consumed by the job.'
    )
    hyperparameterMetricTag: Optional[str] = Field(
        None,
    ...
    isBuiltInAlgorithmJob: Optional[bool] = Field(
        None, description='Whether this job is a built-in Algorithm job.'
    )
    isHyperparameterTuningJob: Optional[bool] = Field(
        None, description='Whether this job is a hyperparameter tuning job.'
    )
    trials: Optional[List[GoogleCloudMlV1HyperparameterOutput]] = Field(
        None,
...
class GoogleCloudMlV1Trial(BaseModel):
    ...
    finalMeasurement: Optional[GoogleCloudMlV1Measurement] = Field(
        None, description='The final measurement containing the objective value.'
    )
    ...
    measurements: Optional[List[GoogleCloudMlV1Measurement]] = Field(
        None,
    ...
    name: Optional[str] = Field(
        None, description='Output only. Name of the trial assigned by the service.'
    )
    parameters: Optional[List[GoogleCloudMlV1TrialParameter]] = Field(
        None, description='The parameters of the trial.'
    )
    startTime: Optional[str] = Field(
        None, description='Output only. Time at which the trial was started.'
    )
    state: Optional[State3] = Field(None, description='The detailed state of a trial.')
    trialInfeasible: Optional[bool] = Field(
        None,
...
class GoogleCloudMlV1AddTrialMeasurementRequest(BaseModel):
    measurement: Optional[GoogleCloudMlV1Measurement] = Field(
        None, description='Required. The measurement to be added to a trial.'
    )
...
class GoogleCloudMlV1AutoScaling(BaseModel):
    ...
    metrics: Optional[List[GoogleCloudMlV1MetricSpec]] = Field(
        None,
...
class GoogleCloudMlV1ContainerSpec(BaseModel):
    ...
    env: Optional[List[GoogleCloudMlV1EnvVar]] = Field(
        None,
    ...
    ports: Optional[List[GoogleCloudMlV1ContainerPort]] = Field(
        None,
...
class GoogleCloudMlV1ExplanationConfig(BaseModel):
    integratedGradientsAttribution: Optional[
    ...
    sampledShapleyAttribution: Optional[GoogleCloudMlV1SampledShapleyAttribution] = (
        Field(
            None,
    ...
    xraiAttribution: Optional[GoogleCloudMlV1XraiAttribution] = Field(
        None,
...
class GoogleCloudMlV1HyperparameterSpec(BaseModel):
    ...
    enableTrialEarlyStopping: Optional[bool] = Field(
        None,
    ...
    maxFailedTrials: Optional[int] = Field(
        None,
    ...
    maxParallelTrials: Optional[int] = Field(
        None,
    ...
    params: Optional[List[GoogleCloudMlV1ParameterSpec]] = Field(
        None, description='Required. The set of parameters to tune.'
    )
    resumePreviousJobId: Optional[str] = Field(
        None,
...
class GoogleCloudMlV1ListLocationsResponse(BaseModel):
    locations: Optional[List[GoogleCloudMlV1Location]] = Field(
        None,
...
class GoogleCloudMlV1ListOptimalTrialsResponse(BaseModel):
    trials: Optional[List[GoogleCloudMlV1Trial]] = Field(
        None,
...
class GoogleCloudMlV1ListTrialsResponse(BaseModel):
    trials: Optional[List[GoogleCloudMlV1Trial]] = Field(
        None, description='The trials associated with the study.'
    )


class GoogleCloudMlV1Study(BaseModel):
    createTime: Optional[str] = Field(
        None, description='Output only. Time at which the study was created.'
    )
    inactiveReason: Optional[str] = Field(
        None,
    ...
    name: Optional[str] = Field(None, description='Output only. The name of a study.')
    state: Optional[State2] = Field(
        None, description='Output only. The detailed state of a study.'
    )
    studyConfig: Optional[GoogleCloudMlV1StudyConfig] = Field(
        None, description='Required. Configuration of the study.'
    )
...
class GoogleCloudMlV1SuggestTrialsResponse(BaseModel):
    ...
    studyState: Optional[StudyState] = Field(
        None, description='The state of the study.'
    )
    trials: Optional[List[GoogleCloudMlV1Trial]] = Field(
        None, description='A list of trials.'
    )
...
class GoogleCloudMlV1TrainingInput(BaseModel):
    ...
    evaluatorCount: Optional[str] = Field(
        None,
    ...
    evaluatorType: Optional[str] = Field(
        None,
    ...
    hyperparameters: Optional[GoogleCloudMlV1HyperparameterSpec] = Field(
        None, description='Optional. The set of Hyperparameters to tune.'
    )
    ...
    masterConfig: Optional[GoogleCloudMlV1ReplicaConfig] = Field(
        None,
    ...
    packageUris: Optional[List[str]] = Field(
        None,
    ...
    parameterServerConfig: Optional[GoogleCloudMlV1ReplicaConfig] = Field(
        None,
    ...
    parameterServerCount: Optional[str] = Field(
        None,
    ...
    parameterServerType: Optional[str] = Field(
        None,
    ...
    pythonModule: Optional[str] = Field(
        None,
...
class GoogleCloudMlV1Version(BaseModel):
    ...
    autoScaling: Optional[GoogleCloudMlV1AutoScaling] = Field(
        None,
    ...
    container: Optional[GoogleCloudMlV1ContainerSpec] = Field(
        None,
        description='Optional. Specifies a custom container to use for serving predictions. If you specify this field, then `machineType` is required. If you specify this field, then `deploymentUri` is optional. If you specify this field, then you must not specify `runtimeVersion`, `packageUris`, `framework`, `pythonVersion`, or `predictionClass`.',
    )
    createTime: Optional[str] = Field(
        None, description='Output only. The time the version was created.'
    )
    deploymentUri: Optional[str] = Field(
        None,
    ...
    errorMessage: Optional[str] = Field(
        None, description='Output only. The details of a failure or a cancellation.'
    )
    ...
    explanationConfig: Optional[GoogleCloudMlV1ExplanationConfig] = Field(
        None,
    ...
    lastMigrationModelId: Optional[str] = Field(
        None,
    ...
    lastMigrationTime: Optional[str] = Field(
        None,
    ...
    lastUseTime: Optional[str] = Field(
        None,
    ...
    manualScaling: Optional[GoogleCloudMlV1ManualScaling] = Field(
        None,
    ...
    predictionClass: Optional[str] = Field(
        None,
    ...
    requestLoggingConfig: Optional[GoogleCloudMlV1RequestLoggingConfig] = Field(
        None,
    ...
    routes: Optional[GoogleCloudMlV1RouteMap] = Field(
        None,
    ...
    state: Optional[State4] = Field(
        None, description='Output only. The state of a version.'
    )
...
class GoogleCloudMlV1Job(BaseModel):
    ...
    endTime: Optional[str] = Field(
        None, description='Output only. When the job processing was completed.'
    )
    errorMessage: Optional[str] = Field(
        None, description='Output only. The details of a failure or a cancellation.'
    )
    ...
    jobId: Optional[str] = Field(
        None, description='Required. The user-specified id of the job.'
    )
    jobPosition: Optional[str] = Field(
        None,
    ...
    predictionInput: Optional[GoogleCloudMlV1PredictionInput] = Field(
        None, description='Input parameters to create a prediction job.'
    )
    predictionOutput: Optional[GoogleCloudMlV1PredictionOutput] = Field(
        None, description='The current prediction job result.'
    )
    startTime: Optional[str] = Field(
        None, description='Output only. When the job processing was started.'
    )
    state: Optional[State] = Field(
        None, description='Output only. The detailed state of a job.'
    )
    trainingInput: Optional[GoogleCloudMlV1TrainingInput] = Field(
        None, description='Input parameters to create a training job.'
    )
    trainingOutput: Optional[GoogleCloudMlV1TrainingOutput] = Field(
        None, description='The current training job result.'
    )


class GoogleCloudMlV1ListJobsResponse(BaseModel):
    jobs: Optional[List[GoogleCloudMlV1Job]] = Field(
        None, description='The list of jobs.'
    )
    nextPageToken: Optional[str] = Field(
        None,
        description='Optional. Pass this token as the `page_token` field of the request for a subsequent call.',
...
class GoogleCloudMlV1ListStudiesResponse(BaseModel):
    studies: Optional[List[GoogleCloudMlV1Study]] = Field(
        None, description='The studies associated with the project.'
    )
...
class GoogleCloudMlV1ListVersionsResponse(BaseModel):
    ...
    versions: Optional[List[GoogleCloudMlV1Version]] = Field(
        None, description='The list of versions.'
    )


class GoogleCloudMlV1Model(BaseModel):
    defaultVersion: Optional[GoogleCloudMlV1Version] = Field(
        None,
    ...
    onlinePredictionConsoleLogging: Optional[bool] = Field(
        None,
    ...
    onlinePredictionLogging: Optional[bool] = Field(
        None,
...
class GoogleCloudMlV1OperationMetadata(BaseModel):
    createTime: Optional[str] = Field(
        None, description='The time the operation was submitted.'
    )
    endTime: Optional[str] = Field(
        None, description='The time operation processing completed.'
    )
    isCancellationRequested: Optional[bool] = Field(
        None,
    ...
    projectNumber: Optional[str] = Field(
        None, description='Contains the project number associated with the operation.'
    )
    startTime: Optional[str] = Field(
        None, description='The time operation processing started.'
    )
    version: Optional[GoogleCloudMlV1Version] = Field(
        None, description='Contains the version associated with the operation.'
    )
...
class GoogleCloudMlV1ListModelsResponse(BaseModel):
    models: Optional[List[GoogleCloudMlV1Model]] = Field(
...
GoogleCloudMlV1StudyConfigParameterSpec.model_rebuild()
